            ...
            <div className="col-span-5 flex flex-wrap flex-col gap-2">
                <div className="col-span-12">
                    {previewImage ? (
                        ...
                        />
                    ) : reelForm?.reel_media?.find(media => media.thumbnail === 'thumbnail') ? (
                        <img
                            src={`${constants.BASE_ASSET_URL}/storage/${
                                reelForm.reel_media.find(media => media.thumbnail === 'thumbnail').media_path
                            }`}
                            alt="Thumbnail"
                            style={{  objectFit: 'cover', borderRadius: '15px' }}
                        />
