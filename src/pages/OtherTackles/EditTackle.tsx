...
const EditTackles: React.FC = () => {
  ...
  return (
        ...
        <div className="col-span-6 flex flex-col gap-2">
                ...
                <div className='grid grid-cols-12 gap-4'>
                    ...
                    {/* <div className='col-span-6 flex flex-col gap-2'>
                        ...
                        type="date"
                        name="add_date"
                        value={tacklesForm.add_date || new Date().toISOString().split('T')[0]}
                        onChange={handleInputChange}
                        className="border border-blue-300 w-full p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                    </div> */}
            ...
            <div className="col-span-12">
                ...
                (() => {
                    const thumbnailImage = tacklesForm?.tackle_media?.find(media => media.thumbnail === 'thumbnail');
    ...
    <MediaGallery tackle_id={id} onPreviewImage={(url) => setPreviewImage(url)} onMediaChange={fetchTackles} />
    <ToastContainer />
    </>
  );
};
